...
const fs = require('fs');
const companies = masterData.map(m => ({
    name: m.company_name,
    batch: 2025,
    role: m.role,
    package: m.package,
    offers: m.offers,
    location: m.location,
    eligibilityText: m.eligibility || (m.company_type === "Product-based" ? "Technology" : "Consulting"),
    status: "Completed",
    deadline: "Finished",
    min_cgpa: m.min_cgpa,
...
// Add the other companies that were in data.json but not in the master list
const otherCompanies = [
    {
        name: "High-Technext Engineering & Telecom Pvt. Ltd.",
        batch: 2025,
        role: "Technical Site Engineer",
        package: "4.5 LPA",
        offers: 6,
        location: "India",
        eligibilityText: "Engineering",
        status: "Completed",
        deadline: "Finished"
    },
    {
        name: "Earth Crust - (Lets Try) Pvt. Ltd.",
        batch: 2025,
    ...
    },
    {
        ...
        offers: 1,
        location: "India",
        eligibilityText: "EdTech",
        status: "Completed",
        deadline: "Finished"
    }
];

const finalCompanies = [...companies, ...otherCompanies].sort((a,b) => {
    const pkgA = parseFloat(a.package) || 0;
    const pkgB = parseFloat(b.package) || 0;
    return pkgB - pkgA;
});

console.log(JSON.stringify(finalCompanies, null, 2));
